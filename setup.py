...
exec(open(os.path.join(here, "spider", "constants.py")).read())
...
setup(
    ...
    name='scipion-em-spider',  # Required
    ...
    description='Plugin to use Spider programs within the Scipion framework',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-spider',  # Optional
    ...
    package_data={  # Optional
       'spider': ['spider_logo.png', 'protocols.conf'],
    },
